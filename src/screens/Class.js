...
function Class() {
  ...
  const createPost = async () => {
    try {
      ...
      console.error(error);
      alert(`Ocorreu um erro ao tentar postar o comentário, por favor tente novamente!`);
    }
  };
    ...
    <div className="class">
      ...
      <div className="class__nameBox">
        ...
        <div className="main__code">
                <em className="code">Código do grupo :</em>
                <div className="id">{id}</div>
                <div className="class__name">{classData?.desc}</div>
              </div>
      </div>
